...
- **저장소:** 모노레포 단일 repo, `main` 브랜치. origin 최신 커밋 `3fd8df1`(push 완료) — 사장님↔손님 양방향 채팅 + 역할별 계정 분리·내 가게 등록
