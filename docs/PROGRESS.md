...
- **저장소:** 모노레포 단일 repo, `main` 브랜치. origin 최신 커밋 `f83a7ba`(push 완료) — 사장님 취소 시 고객 자동 메시지. 로컬에 홈 종 아이콘 안 읽은 채팅 빨간 점 커밋 대기
